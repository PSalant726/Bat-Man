...
// TODO: Original file calls Maze.reset() at the end of this definition
...
Maze.prototype.isWall = function (pos) {
  return withinBounds(pos.y, pos.x) && this.map[pos.y][pos.x] === Game.WALL;
};
...
Maze.prototype.isFloorSpace = function (pos) {
  ...
  let piece = this.map[pos.y][pos.x];
